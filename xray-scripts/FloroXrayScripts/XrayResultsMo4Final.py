...
def getHisto(rootfile,histo,material,roc):
	...
	if material == "Cu":
		if len(peaks) == 2 :
			...
			gaus2 = TF1("gaus2","gaus",peaks[0][0]-15,peaks[0][0]+15)
			gaus1 = TF1("gaus1","gaus",peaks[2][0]-15,peaks[2][0]+15)
	elif len(peaks) == 4:
		gaus1 = TF1("gaus1","gaus",peaks[2][0]-15,peaks[2][0]+15)
		gaus2 = TF1("gaus2","gaus",peaks[3][0]-15,peaks[3][0]+15)
	elif len(peaks) == 3:
		gaus1 = TF1("gaus1","gaus",peaks[1][0]-15,peaks[1][0]+15)
		gaus2 = TF1("gaus2","gaus",peaks[2][0]-15,peaks[2][0]+15)
	elif len(peaks) == 2:
...
def FitDrawIndyRocSpectrums( filmlist, histname, nrocs, output, prestring, poststring ):
	...
	for roc in range(0,int(nrocs)):

		print 'Getting fits for Roc: ' + str(roc)
		objects = []
		ele = filmlist[0]
		rootfilename = prestring + ele + poststring
...
def FitDrawSumRocSpectrums(  filmlist, histname, nrocs, output, prestring, poststring ):
	...
	for roc in range(0,int(nrocs)):
		...
		rootfilename1 = prestring + filmlist[0] + poststring
		...
		rootfilename2 = prestring + filmlist[1] + poststring
		...
		rootfilename3 = prestring + filmlist[2] + poststring
		...
		rootfilename4 = prestring + filmlist[3] + poststring
