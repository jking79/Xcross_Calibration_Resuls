...
##	plt.plot( lhitrate[ele], invert(lfiduc[ele]), pc1, label = "Fiducial" )
	plt.plot( lhitrate[ele], invert(loverall[ele]), pc2, label = olabel )
plt.legend(loc='upper left')
plt.ylabel("% InEfficency" )
plt.xlabel("MHz/cm^2") 
plt.title("InEfficency vs Hit Rate: N00902")
